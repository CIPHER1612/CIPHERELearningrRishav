...
public class CSS5S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_css5_s6);
        Exp_list = findViewById(R.id.exp_listcss5s6);
        Movies_category = DataProviderCSS5S6.getInfo();
