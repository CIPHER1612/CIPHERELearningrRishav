...
public class DataProviderMES4S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("THEORY OF METAL CUTTING", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("LATHE AND OPERATIONS", Differential_Calculus);
        MoviesDetails.put("RECIPROCATING MACHINE TOOLS", Applications_of_Differentiation);
        MoviesDetails.put("DRILLING AND MILLING  MACHINES", Integral_Calculus);
        MoviesDetails.put("SUPER FINISHING PROCESSES", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("NON CONVENTIONAL MACHINING PROCESS", Differential_Equiations);
