...
public class FTS1S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts1_s1);
        Exp_list = findViewById(R.id.exp_listfts1s1);
        Movies_category = DataProviderFTS1S1.getInfo();
