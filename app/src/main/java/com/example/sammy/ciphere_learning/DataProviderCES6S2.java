...
public class DataProviderCES6S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Introduction to project management", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Planning & scheduling", Differential_Calculus);
        MoviesDetails.put("Construction project practices", Applications_of_Differentiation);
        MoviesDetails.put(" Safety & quality management ", Integral_Calculus);
        MoviesDetails.put(" Valuation of buildings ", Integral_Calculus);
        MoviesDetails.put(" Entrepreneurship ", Definite_Integrals_and_its_Applicaitons);
