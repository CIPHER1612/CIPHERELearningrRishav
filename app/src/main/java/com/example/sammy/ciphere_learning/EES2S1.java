...
public class EES2S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees2_s1);
        Exp_list = findViewById(R.id.exp_listees2s1);
        Movies_category = DataProviderEES2S1.getInfo();
