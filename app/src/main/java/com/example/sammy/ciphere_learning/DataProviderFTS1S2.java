...
public class DataProviderFTS1S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("SEWING MACHINE", Digital_and_Computer_Fundamentals);
        MoviesDetails.put(" TECHNICAL TERMS, SEAMS AND STITCHES", Differential_Calculus);
        MoviesDetails.put("INTRODUCTION TO FULLNESS ", Applications_of_Differentiation);
        MoviesDetails.put(" FABRIC TEXTURING", Integral_Calculus);
        MoviesDetails.put("TRIMS", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("STUDY OF FABRICS", Differential_Equiations);
