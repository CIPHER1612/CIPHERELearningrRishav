...
public class EES4S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees4_s2);
        Exp_list = findViewById(R.id.exp_listees4s2);
        Movies_category = DataProviderEES4S2.getInfo();
