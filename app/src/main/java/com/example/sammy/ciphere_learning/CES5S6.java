...
public class CES5S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces5_s6);
        Exp_list = findViewById(R.id.exp_listces5s6);
        Movies_category = DataProviderCES5S6.getInfo();
