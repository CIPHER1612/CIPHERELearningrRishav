...
public class MES5S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes5_s1);
        Exp_list = findViewById(R.id.exp_listmes5s1);
        Movies_category = DataProviderMES5S1.getInfo();
