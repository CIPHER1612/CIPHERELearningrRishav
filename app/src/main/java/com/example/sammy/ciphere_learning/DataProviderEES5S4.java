...
public class DataProviderEES5S4 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put(" Service Mains  ", Differential_Calculus);
        MoviesDetails.put("  Lighting Installations  ", Applications_of_Differentiation);
        MoviesDetails.put(" Power Installations ", Integral_Calculus);
        MoviesDetails.put("Distribution lines and Transformer centre  ", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Transmission lines and substations ", Differential_Equiations);
