...
public class EES3S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees3_s4);
        Exp_list = findViewById(R.id.exp_listees3s4);
        Movies_category = DataProviderEES3S4.getInfo();
