...
public class EES5S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees5_s1);
        Exp_list = findViewById(R.id.exp_listees5s1);
        Movies_category = DataProviderEES5S1.getInfo();
