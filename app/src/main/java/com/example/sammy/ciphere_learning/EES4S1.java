...
public class EES4S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees4_s1);
        Exp_list = findViewById(R.id.exp_listees4s1);
        Movies_category = DataProviderEES4S1.getInfo();
