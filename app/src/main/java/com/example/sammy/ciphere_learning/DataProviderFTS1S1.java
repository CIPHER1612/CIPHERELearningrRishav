...
public class DataProviderFTS1S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("CLASSIFICATION OF TOOLS AND EQUIPMENTS", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("MEASUREMENTS", Differential_Calculus);
        MoviesDetails.put("NECKLINES", Applications_of_Differentiation);
        MoviesDetails.put("SLEEVES", Integral_Calculus);
        MoviesDetails.put("COLLARS", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("PLACKETS, CUFFS AND POCKETS", Differential_Equiations);
