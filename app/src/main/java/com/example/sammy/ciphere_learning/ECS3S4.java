...
public class ECS3S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs3_s4);
        Exp_list = findViewById(R.id.exp_listecs3s4);
        Movies_category = DataProviderECS3S4.getInfo();
