...
public class MES5S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes5_s6);
        Exp_list = findViewById(R.id.exp_listmes5s6);
        Movies_category = DataProviderMES5S6.getInfo();
