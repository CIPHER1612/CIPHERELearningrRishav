...
public class EES1S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces1_s2);
        Exp_list = findViewById(R.id.exp_listces1s2);
        Movies_category = DataProviderEES1S2.getInfo();
