...
public class DataProviderCES6S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Surveys & Planning,Zoning", Differential_Calculus);
        MoviesDetails.put("Housing,Slums,Public buildings ", Applications_of_Differentiation);
        MoviesDetails.put("Recreation Measures,Master Plan ", Integral_Calculus);
        MoviesDetails.put(" Re- planning of existing towns", Integral_Calculus);
        MoviesDetails.put("Urban Roads,Traffic Management ", Definite_Integrals_and_its_Applicaitons);
