...
public class Sem6ME extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
           /* case R.id.Subject1:
                startActivity(new Intent(this, MES6S1.class));
                break;
            case R.id.Subject2:
                startActivity(new Intent(this, MES6S2.class));
                break;
            case R.id.Subject3:
                startActivity(new Intent(this, MES6S3.class));
                break;
            case R.id.Subject4:
                startActivity(new Intent(this, MES6S4.class));
                break;
            case R.id.Subject5:
                startActivity(new Intent(this, MES6S5.class));
                break;
            case R.id.Subject6:
                startActivity(new Intent(this, MES6S6.class));
                break;
            case R.id.Subject7:
                startActivity(new Intent(this, MES6S7.class));
                break;
