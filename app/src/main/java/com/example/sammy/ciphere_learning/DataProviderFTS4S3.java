...
public class DataProviderFTS4S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Fabric Finishes", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Printing", Differential_Calculus);
        MoviesDetails.put("Knitting", Applications_of_Differentiation);
        MoviesDetails.put("Felted fabric", Integral_Calculus);
        MoviesDetails.put("Decorative Fabric construction", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Leather", Differential_Equiations);
