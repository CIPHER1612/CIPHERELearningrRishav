...
public class CES2S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces2_s4);
        Exp_list = findViewById(R.id.exp_listces2s4);
        Movies_category = DataProviderCES2S4.getInfo();
