...
public class DataProviderCES4S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Fluids, pressure & its measurements and hydrostatics", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Flow of fluids", Differential_Calculus);
        MoviesDetails.put("Flow through orifices, notches and weirs", Applications_of_Differentiation);
        MoviesDetails.put("Flow through pipes", Integral_Calculus);
        MoviesDetails.put("Flow through channels", Integral_Calculus);
        MoviesDetails.put("Pumps and turbines", Definite_Integrals_and_its_Applicaitons);
