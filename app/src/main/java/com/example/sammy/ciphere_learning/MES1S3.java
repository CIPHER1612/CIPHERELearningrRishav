...
public class MES1S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes1_s3);
        Exp_list = findViewById(R.id.exp_listmes1s3);
        Movies_category = DataProviderMES1S3.getInfo();
