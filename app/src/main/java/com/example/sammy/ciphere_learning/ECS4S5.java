...
public class ECS4S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs4_s5);
        Exp_list = findViewById(R.id.exp_listecs4s5);
        Movies_category = DataProviderECS4S5.getInfo();
