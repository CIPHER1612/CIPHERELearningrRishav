...
public class Sem6CS extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sem6_cs);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.Subject1:
                ...
                break;
            case R.id.Subject2:
                startActivity(new Intent(this, CSS6S2.class));
                break;
            case R.id.Subject3:
                startActivity(new Intent(this, CSS6S3.class));
                break;
            case R.id.Subject4:
                startActivity(new Intent(this, CSS6S4.class));
                break;
            case R.id.Subject5:
                startActivity(new Intent(this, CSS6S5.class));
                break;
            case R.id.Subject6:
                startActivity(new Intent(this, CSS6S6.class));
                break;
