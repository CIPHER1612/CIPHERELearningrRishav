...
public class DataProviderFTS3S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Hand Embroidery", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Hand embroidery stitches", Differential_Calculus);
        MoviesDetails.put("Machine Embroidery", Applications_of_Differentiation);
        MoviesDetails.put("Machine Embroidery Stitches", Integral_Calculus);
        MoviesDetails.put("Knitting tools", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Basic knitting Stitches", Differential_Equiations);
