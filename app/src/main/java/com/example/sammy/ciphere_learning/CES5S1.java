...
public class CES5S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces5_s1);
        Exp_list = findViewById(R.id.exp_listces5s1);
        Movies_category = DataProviderCES5S1.getInfo();
