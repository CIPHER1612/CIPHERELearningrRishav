...
public class DataProviderCES2S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put(" Introduction  and chain surveying", Digital_and_Computer_Fundamentals);
        MoviesDetails.put(" Compass surveying ", Differential_Calculus);
        MoviesDetails.put("Leveling", Applications_of_Differentiation);
        MoviesDetails.put(" Leveling application ", Integral_Calculus);
        MoviesDetails.put("Contouring", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Areas  and volumes", Differential_Equiations);
