...
public class MES5S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes5_s3);
        Exp_list = findViewById(R.id.exp_listmes5s3);
        Movies_category = DataProviderMES5S3.getInfo();
