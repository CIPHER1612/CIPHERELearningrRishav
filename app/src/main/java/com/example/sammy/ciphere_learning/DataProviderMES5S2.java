...
public class DataProviderMES5S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("FORMATION OF STEAM", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("STEAM BOILERS", Differential_Calculus);
        MoviesDetails.put("STEAM CONDENSERS, COOLING TOWERS AND STEAM NOZZELS", Applications_of_Differentiation);
        MoviesDetails.put("STEAM TURBINES", Integral_Calculus);
        MoviesDetails.put("AIR COMPRESSORS ", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("REFRIGERATION AND AIR CONDITIONING", Differential_Equiations);
