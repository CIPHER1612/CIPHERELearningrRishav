...
public class MES4S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes4_s5);
        Exp_list = findViewById(R.id.exp_listmes4s5);
        Movies_category = DataProviderMES4S5.getInfo();
