...
public class FTS1S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts1_s2);
        Exp_list = findViewById(R.id.exp_listfts1s2);
        Movies_category = DataProviderFTS1S2.getInfo();
