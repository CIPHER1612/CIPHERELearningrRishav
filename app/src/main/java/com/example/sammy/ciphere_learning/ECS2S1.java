...
public class ECS2S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs2_s1);
        Exp_list = findViewById(R.id.exp_listecs2s1);
        Movies_category = DataProviderECS2S1.getInfo();
