...
public class CES2S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces2_s3);
        Exp_list = findViewById(R.id.exp_listces2s3);
        Movies_category = DataProviderCES2S3.getInfo();
