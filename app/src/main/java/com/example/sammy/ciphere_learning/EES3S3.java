...
public class EES3S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees3_s3);
        Exp_list = findViewById(R.id.exp_listees3s3);
        Movies_category = DataProviderEES3S3.getInfo();
