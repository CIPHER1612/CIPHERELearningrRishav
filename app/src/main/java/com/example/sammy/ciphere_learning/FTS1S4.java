...
public class FTS1S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts1_s4);
        Exp_list = findViewById(R.id.exp_listfts1s4);
        Movies_category = DataProviderFTS1S4.getInfo();
