...
public class CES4S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces4_s2);
        Exp_list = findViewById(R.id.exp_listces4s2);
        Movies_category = DataProviderCES4S2.getInfo();
