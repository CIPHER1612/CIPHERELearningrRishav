...
public class CES6S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces6_s4);
        Exp_list = findViewById(R.id.exp_listces6s4);
        Movies_category = DataProviderCES6S4.getInfo();
