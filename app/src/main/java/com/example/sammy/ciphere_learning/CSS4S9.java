...
public class CSS4S9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_css4_s9);
        ...
        css1c1t1.loadUrl("https://drive.google.com/open?id=1tKPgR-bwGvWqTkTkAjprJJFZzPWpetGN");
