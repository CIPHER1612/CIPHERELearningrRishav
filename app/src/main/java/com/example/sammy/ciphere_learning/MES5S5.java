...
public class MES5S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes5_s5);
        Exp_list = findViewById(R.id.exp_listmes5s5);
        Movies_category = DataProviderMES5S5.getInfo();
