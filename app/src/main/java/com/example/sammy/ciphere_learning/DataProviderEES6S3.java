...
public class DataProviderEES6S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put(" Introduction to Mechatronics System ", Digital_and_Computer_Fundamentals);
        MoviesDetails.put(" Transducers and Sensors  ", Differential_Calculus);
        MoviesDetails.put("Signal Conditioning ,Data Acquisition and data presentation ", Applications_of_Differentiation);
        MoviesDetails.put(" Actuation system  ", Integral_Calculus);
        MoviesDetails.put("Applications of Mechatronics  system ", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put(" PLC and MEMS ", Differential_Equiations);
