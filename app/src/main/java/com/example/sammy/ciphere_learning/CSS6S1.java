...
public class CSS6S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_css6_s1);
        Exp_list = findViewById(R.id.exp_listcss6s1);
        Movies_category = DataProviderCSS6S1.getInfo();
