...
public class FTS5S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts5_s5);
        Exp_list = findViewById(R.id.exp_listfts5s5);
        Movies_category = DataProviderFTS5S5.getInfo();
