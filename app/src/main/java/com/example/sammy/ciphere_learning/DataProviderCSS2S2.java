...
public class DataProviderCSS2S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("DIGITAL PRINCIPLES", CARRER_PLANNING);
        MoviesDetails.put("BOOLEAN ALGEBRA & LOGIC GATES", THE_GREAT_INDIAN_PSYCHOTHERAPY);
        MoviesDetails.put("COMBINATIONAL CIRCUITS ", GLOBAL_WARMING);
        MoviesDetails.put("SEQUENTIAL CIRCUITS", RENDEZVOUS_WITH_A_WOMAN_CORPORATE_GIANT);
        MoviesDetails.put("INTRODUCTION TO COMPUTERS AND COMPUTER SOFTWARE", A_UNIQUE_PATIENT);
        MoviesDetails.put("PERIPHERALS & MEMORY", A_FARMER_WIFE);
