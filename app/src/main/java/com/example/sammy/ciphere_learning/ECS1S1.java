...
public class ECS1S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs1_s1);
        Exp_list = findViewById(R.id.exp_listecs1s1);
        Movies_category = DataProviderECS1S1.getInfo();
