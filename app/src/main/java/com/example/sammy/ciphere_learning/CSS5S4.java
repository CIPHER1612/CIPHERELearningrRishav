...
public class CSS5S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_css5_s4);
        Exp_list = findViewById(R.id.exp_listcss5s4);
        Movies_category = DataProviderCSS5S4.getInfo();
