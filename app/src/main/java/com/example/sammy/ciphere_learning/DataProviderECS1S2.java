...
public class DataProviderECS1S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("MECHANICS ", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("PROPERTIES OF SOLIDS AND LIQUIDS", Differential_Calculus);
        MoviesDetails.put("HEAT AND PROPERTIES OF GASES", Applications_of_Differentiation);
        MoviesDetails.put("WAVE MOTION", Integral_Calculus);
        MoviesDetails.put("MODERN PHYSICS", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("INDUSTRIAL CHEMISTRY", Differential_Equiations);
