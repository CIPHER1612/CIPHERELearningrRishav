...
public class MES3S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes3_s4);
        Exp_list = findViewById(R.id.exp_listmes3s4);
        Movies_category = DataProviderMES3S4.getInfo();
