...
public class MES6S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes6_s3);
        Exp_list = findViewById(R.id.exp_listmes6s3);
        Movies_category = DataProviderMES6S3.getInfo();
