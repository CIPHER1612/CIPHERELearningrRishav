...
public class DataProviderEES5S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("TRANSMISSION SYSTEMS", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("HVDC, FACTS AND SUB-STATIONS ", Differential_Calculus);
        MoviesDetails.put("DISTRIBUTION SYSTEMS ", Applications_of_Differentiation);
        MoviesDetails.put("ELECTRIC HEATING AND WELDING ", Integral_Calculus);
        MoviesDetails.put("ELECTRO-CHEMICAL PROCESS, REFRIGERATION AND AIR CONDITIONING ", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put(" ILLUMINATION  ", Differential_Equiations);
