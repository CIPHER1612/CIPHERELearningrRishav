...
public class FTS2S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts2_s2);
        Exp_list = findViewById(R.id.exp_listfts2s2);
        Movies_category = DataProviderFTS2S2.getInfo();
