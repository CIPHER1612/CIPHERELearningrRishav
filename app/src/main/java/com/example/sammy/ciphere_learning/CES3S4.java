...
public class CES3S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces3_s4);
        Exp_list = findViewById(R.id.exp_listces3s4);
        Movies_category = DataProviderCES3S4.getInfo();
