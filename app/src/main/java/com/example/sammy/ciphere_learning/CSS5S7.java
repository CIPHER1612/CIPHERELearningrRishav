...
public class CSS5S7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_css5_s7);
        Exp_list = findViewById(R.id.exp_listcss5s7);
        Movies_category = DataProviderCSS5S7.getInfo();
