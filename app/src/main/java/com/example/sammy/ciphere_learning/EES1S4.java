...
public class EES1S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces1_s4);
        Exp_list = findViewById(R.id.exp_listces1s4);
        Movies_category = DataProviderEES1S4.getInfo();
