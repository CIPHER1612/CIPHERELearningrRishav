...
public class DataProviderFTS5S4 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("STUDY OF MEN’S GARMENTS", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("ABOVE WAIST GARMENTS", Differential_Calculus);
        MoviesDetails.put("BELOW WAIST GARMENTS", Applications_of_Differentiation);
        MoviesDetails.put("FABRIC STUDY", Integral_Calculus);
        MoviesDetails.put("LABELS & PRESSING", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("PREPARATION OF BASIC BLOCKS", Differential_Equiations);
