...
public class EES2S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees2_s6);
        Exp_list = findViewById(R.id.exp_listees2s6);
        Movies_category = DataProviderEES2S6.getInfo();
