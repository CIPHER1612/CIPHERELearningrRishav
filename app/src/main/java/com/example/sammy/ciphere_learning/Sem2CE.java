...
public class Sem2CE extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {/*
            case R.id.Subj1CE:
                startActivity(new Intent(this, CES2S1.class));
                break;
            case R.id.Subj2CE:
                startActivity(new Intent(this, CES2S2.class));
                break;
            case R.id.Subj3CE:
                startActivity(new Intent(this, CES2S3.class));
                break;
            case R.id.Subj4CE:
                startActivity(new Intent(this, CES2S4.class));
                break;
            case R.id.Subj5CE:
                startActivity(new Intent(this, CES2S5.class));
                break;
            case R.id.Subj6CE:
                startActivity(new Intent(this, CES2S6.class));
                break;
