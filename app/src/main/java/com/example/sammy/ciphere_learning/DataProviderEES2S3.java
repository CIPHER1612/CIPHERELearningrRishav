...
public class DataProviderEES2S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Introduction and DC circuits", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Magnetism and magnetic circuits", Differential_Calculus);
        MoviesDetails.put("Electromagnetic Induction\n", Applications_of_Differentiation);
        MoviesDetails.put("AC Principles and Vector Algebra", Integral_Calculus);
        MoviesDetails.put("Single-phase AC circuits", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Poly-phase AC circuits", Differential_Equiations);
