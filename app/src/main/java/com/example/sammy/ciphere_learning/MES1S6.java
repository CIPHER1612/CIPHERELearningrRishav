...
public class MES1S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes1_s6);
        Exp_list = findViewById(R.id.exp_listmes1s6);
        Movies_category = DataProviderMES1S6.getInfo();
