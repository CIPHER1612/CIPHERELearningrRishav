...
public class EES5S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees5_s5);
        Exp_list = findViewById(R.id.exp_listees5s5);
        Movies_category = DataProviderEES5S5.getInfo();
