...
public class DataProviderFTS6S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("STUDY OF BASIC BLOCKS AND ADOPTATON METHOD", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("STUDY OF GARMENTS (Flat pattern Technique)", Differential_Calculus);
        MoviesDetails.put("DRAPING ( Draping technique)", Applications_of_Differentiation);
        MoviesDetails.put("BASIC PATTERN ( Draping technique)", Integral_Calculus);
        MoviesDetails.put("DART – PLEATS- TUCKS (Draping technique)", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("STUDY OF DRAPING METHOD ( Draping technique)", Differential_Equiations);
