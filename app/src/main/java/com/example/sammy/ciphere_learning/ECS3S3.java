...
public class ECS3S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs3_s3);
        Exp_list = findViewById(R.id.exp_listecs3s3);
        Movies_category = DataProviderECS3S3.getInfo();
