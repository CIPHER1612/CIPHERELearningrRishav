...
public class DataProviderCSS1S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("MATRICES AND DETERMINANTS", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("VECTORS", Differential_Calculus);
        MoviesDetails.put("PROBABILITY AND LOGARITHMS", Applications_of_Differentiation);
        MoviesDetails.put("ALLIED ANGLES AND COMPOUND ANGLES", Integral_Calculus);
        MoviesDetails.put("COMPLEX NUMBERS", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("INTRODUCTION TO CALCULUS", Differential_Equiations);
