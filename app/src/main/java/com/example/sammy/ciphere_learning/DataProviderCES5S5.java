...
public class DataProviderCES5S5 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Earthen dams and canals", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Tank sluice", Differential_Calculus);
        MoviesDetails.put("Tank weirs", Applications_of_Differentiation);
        MoviesDetails.put("Culverts", Integral_Calculus);
        MoviesDetails.put("T-beam bridges", Integral_Calculus);
