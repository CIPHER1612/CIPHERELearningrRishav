...
public class CES2S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces2_s2);
        Exp_list = findViewById(R.id.exp_listces2s2);
        Movies_category = DataProviderCES2S2.getInfo();
