...
public class DataProviderFTS1S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("HUMAN ANATOMY", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("PRINCIPLES AND ELEMENTS", Differential_Calculus);
        MoviesDetails.put("INTRODUCTION TO FASHION ", Applications_of_Differentiation);
        MoviesDetails.put("FAHSION INDUSTRY", Integral_Calculus);
        MoviesDetails.put("FASHION PROMOTION", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("COSTUMES", Differential_Equiations);
