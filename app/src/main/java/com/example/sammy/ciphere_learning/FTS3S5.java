...
public class FTS3S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts3_s5);
        Exp_list = findViewById(R.id.exp_listfts3s5);
        Movies_category = DataProviderFTS3S5.getInfo();
