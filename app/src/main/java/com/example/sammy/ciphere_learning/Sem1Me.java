...
public class Sem1Me extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sem1_me);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
           /* case R.id.Subject1:
                startActivity(new Intent(this, MES1S1.class));
                break;
            case R.id.Subject2:
                startActivity(new Intent(this, MES1S2.class));
                break;
            case R.id.Subject3:
                startActivity(new Intent(this, MES1S3.class));
                break;
            case R.id.Subject4:
                startActivity(new Intent(this, MES1S4.class));
                break;
            case R.id.Subject5:
                startActivity(new Intent(this, MES1S5.class));
                break;
            case R.id.Subject6:
                startActivity(new Intent(this, MES1S6.class));
                break;
