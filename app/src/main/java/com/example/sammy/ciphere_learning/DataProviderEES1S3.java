...
public class DataProviderEES1S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Introduction and Electrical current and  voltage\n", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("DC  circuits and Resistance and temperature effects", Differential_Calculus);
        MoviesDetails.put("Work, Power and Energy", Applications_of_Differentiation);
        MoviesDetails.put("Electrostatics", Integral_Calculus);
        MoviesDetails.put("Faraday’s laws of Electrolysis", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Electrical Engineering Materials", Differential_Equiations);
