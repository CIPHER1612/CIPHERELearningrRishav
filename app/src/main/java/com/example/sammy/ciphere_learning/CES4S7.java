...
public class CES4S7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces4_s7);
        Exp_list = findViewById(R.id.exp_listces4s7);
        Movies_category = DataProviderCES4S7.getInfo();
