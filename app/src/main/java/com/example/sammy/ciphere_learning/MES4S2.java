...
public class MES4S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes4_s2);
        Exp_list = findViewById(R.id.exp_listmes4s2);
        Movies_category = DataProviderMES4S2.getInfo();
