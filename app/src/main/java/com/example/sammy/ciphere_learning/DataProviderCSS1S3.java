...
public class DataProviderCSS1S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("ELECTRIC CIRCUIT FUNDAMENTALS", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("ELECTROMAGNETISM", Differential_Calculus);
        MoviesDetails.put("AC FUNDAMENTALS", Applications_of_Differentiation);
        MoviesDetails.put("TRANSFORMERS AND STEPPER MOTORS", Integral_Calculus);
        MoviesDetails.put("PROTECTIVE DEVICES", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("BASICS OF ELECTRONICS AND UPS", Differential_Equiations);
