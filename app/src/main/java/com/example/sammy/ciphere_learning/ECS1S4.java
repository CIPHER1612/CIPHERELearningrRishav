...
public class ECS1S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs1_s4);
        Exp_list = findViewById(R.id.exp_listecs1s4);
        Movies_category = DataProviderECS1S4.getInfo();
