...
public class MES3S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes3_s6);
        Exp_list = findViewById(R.id.exp_listmes3s6);
        Movies_category = DataProviderMES3S6.getInfo();
