...
public class EES4S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees4_s4);
        Exp_list = findViewById(R.id.exp_listees4s4);
        Movies_category = DataProviderEES4S4.getInfo();
