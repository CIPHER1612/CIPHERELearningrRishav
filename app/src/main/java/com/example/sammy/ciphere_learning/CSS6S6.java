...
public class CSS6S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_css6_s6);
        Exp_list = findViewById(R.id.exp_listcss6s6);
        Movies_category = DataProviderCSS6S6.getInfo();
