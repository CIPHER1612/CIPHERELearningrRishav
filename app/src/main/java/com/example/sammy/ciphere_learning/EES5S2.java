...
public class EES5S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees5_s2);
        Exp_list = findViewById(R.id.exp_listees5s2);
        Movies_category = DataProviderEES5S2.getInfo();
