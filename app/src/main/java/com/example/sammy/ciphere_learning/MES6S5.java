...
public class MES6S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes6_s5);
        Exp_list = findViewById(R.id.exp_listmes6s5);
        Movies_category = DataProviderMES6S5.getInfo();
