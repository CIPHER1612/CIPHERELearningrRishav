...
public class CES1S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces1_s5);
        Exp_list = findViewById(R.id.exp_listces1s5);
        Movies_category = DataProviderCES1S5.getInfo();
