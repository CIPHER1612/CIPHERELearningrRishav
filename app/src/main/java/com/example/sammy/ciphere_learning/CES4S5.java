...
public class CES4S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces4_s5);
        Exp_list = findViewById(R.id.exp_listces4s5);
        Movies_category = DataProviderCES4S5.getInfo();
