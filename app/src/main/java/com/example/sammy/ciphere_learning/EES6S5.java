...
public class EES6S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees6_s5);
        Exp_list = findViewById(R.id.exp_listees6s5);
        Movies_category = DataProviderEES6S5.getInfo();
