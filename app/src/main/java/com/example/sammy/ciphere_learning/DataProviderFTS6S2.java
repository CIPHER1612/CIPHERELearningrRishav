...
public class DataProviderFTS6S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("MARKETING", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("FASHION MARKETING AND FORECASTING", Differential_Calculus);
        MoviesDetails.put("FASHION SHOWS", Applications_of_Differentiation);
        MoviesDetails.put("UAL MERCHANDISING", Integral_Calculus);
        MoviesDetails.put("STORE PLANNING AND DISPLAY", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("FASHION RETAIL", Differential_Equiations);
