...
public class DataProviderEES5S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Power Semiconductor Devices", Digital_and_Computer_Fundamentals);
        MoviesDetails.put(" SCR Control Circuits ", Differential_Calculus);
        MoviesDetails.put("Ratings, Protection & Mounting of Thyristors ", Applications_of_Differentiation);
        MoviesDetails.put(" Converters ", Integral_Calculus);
        MoviesDetails.put("Power Supplies and Stabilizers", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Applications", Differential_Equiations);
