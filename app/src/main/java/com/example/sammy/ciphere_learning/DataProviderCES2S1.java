...
public class DataProviderCES2S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("COORDINATE GEOMETRY", Digital_and_Computer_Fundamentals);
        MoviesDetails.put(" DIFFERENTIAL CALCULUS", Differential_Calculus);
        ...
        MoviesDetails.put(" DEFINITE INTEGRALS AND ITS APPLICATIONS", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("DIFFERENTIAL EQUATIONS", Differential_Equiations);
