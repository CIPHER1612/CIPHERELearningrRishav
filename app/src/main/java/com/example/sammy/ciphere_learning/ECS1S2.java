...
public class ECS1S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs1_s2);
        Exp_list = findViewById(R.id.exp_listecs1s2);
        Movies_category = DataProviderECS1S2.getInfo();
