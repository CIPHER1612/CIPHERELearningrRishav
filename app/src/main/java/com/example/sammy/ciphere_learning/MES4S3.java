...
public class MES4S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes4_s3);
        Exp_list = findViewById(R.id.exp_listmes4s3);
        Movies_category = DataProviderMES4S3.getInfo();
