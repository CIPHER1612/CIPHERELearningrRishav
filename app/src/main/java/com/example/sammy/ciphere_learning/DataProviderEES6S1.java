...
public class DataProviderEES6S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put(" Introduction to Electrical Drives ", Digital_and_Computer_Fundamentals);
        MoviesDetails.put(" Industrial Process & Drives ", Differential_Calculus);
        MoviesDetails.put(" Control System  ", Applications_of_Differentiation);
        MoviesDetails.put("Development of Control Circuit ", Integral_Calculus);
        MoviesDetails.put("Computer Based Industrial Control ", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Electric Traction ", Differential_Equiations);
