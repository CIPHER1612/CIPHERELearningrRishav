...
public class MES3S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes3_s3);
        Exp_list = findViewById(R.id.exp_listmes3s3);
        Movies_category = DataProviderMES3S3.getInfo();
