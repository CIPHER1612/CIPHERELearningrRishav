...
public class DataProviderMES6S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("AUTOMOBILE ENGINE SYSTEM", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("TRANSMISSION SYSTEM", Differential_Calculus);
        MoviesDetails.put("FUEL SYSTEMS & COOLING SYSTEM", Applications_of_Differentiation);
        MoviesDetails.put("CONTROL SYSTEM", Integral_Calculus);
        MoviesDetails.put("SUSPENSION SYSTEMS, WHEELS & TYRES.", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("AUTOMOBILE ELECTRICAL SYSTEMS", Differential_Equiations);
