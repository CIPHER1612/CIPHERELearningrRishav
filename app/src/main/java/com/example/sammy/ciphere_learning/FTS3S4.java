...
public class FTS3S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts3_s4);
        Exp_list = findViewById(R.id.exp_listfts3s4);
        Movies_category = DataProviderFTS3S4.getInfo();
