...
public class EES5S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees5_s6);
        Exp_list = findViewById(R.id.exp_listees5s6);
        Movies_category = DataProviderEES5S6.getInfo();
