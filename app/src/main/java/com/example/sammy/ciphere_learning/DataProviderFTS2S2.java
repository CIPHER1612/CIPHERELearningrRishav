...
public class DataProviderFTS2S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("PAPER PATTERN", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("TECHNICAL TERMS, SYSTEM OF CUTTING", Differential_Calculus);
        MoviesDetails.put("SHRINKING", Applications_of_Differentiation);
        MoviesDetails.put("DETAIL STUDY OF GIRLS GARMENTS:", Integral_Calculus);
        MoviesDetails.put("DETAIL STUDY OF BELOW WAIST GIRLS GARMENTS", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("LAYOUT AND ESTIMATION", Differential_Equiations);
