...
public class EES6S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees6_s6);
        Exp_list = findViewById(R.id.exp_listees6s6);
        Movies_category = DataProviderEES6S6.getInfo();
