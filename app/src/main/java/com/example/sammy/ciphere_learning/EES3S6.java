...
public class EES3S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees3_s6);
        Exp_list = findViewById(R.id.exp_listees3s6);
        Movies_category = DataProviderEES3S6.getInfo();
