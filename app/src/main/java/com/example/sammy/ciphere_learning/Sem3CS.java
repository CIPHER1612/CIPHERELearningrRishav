...
public class Sem3CS extends AppCompatActivity implements View.OnClickListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sem3_cs);
    ...
    public void onClick(View view) {
        /*switch (view.getId()) {
            case R.id.Subject1:
                ...
                break;
            case R.id.Subject2:
                startActivity(new Intent(this, CSS3S2.class));
                break;
            case R.id.Subject3:
                startActivity(new Intent(this, CSS3S3.class));
                break;
            case R.id.Subject4:
                startActivity(new Intent(this, CSS3S4.class));
                break;
            case R.id.Subject5:
                startActivity(new Intent(this, CSS3S5.class));
                break;
            case R.id.Subject6:
                startActivity(new Intent(this, CSS3S6.class));
                break;
            case R.id.Subject7:
                startActivity(new Intent(this, CSS3S7.class));
                break;
            case R.id.Subject8:
                startActivity(new Intent(this, CSS3S8.class));
                break;
            case R.id.Subject9:
