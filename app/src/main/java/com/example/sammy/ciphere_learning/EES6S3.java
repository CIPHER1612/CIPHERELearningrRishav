...
public class EES6S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees6_s3);
        Exp_list = findViewById(R.id.exp_listees6s3);
        Movies_category = DataProviderEES6S3.getInfo();
