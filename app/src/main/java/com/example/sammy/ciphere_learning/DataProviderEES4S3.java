...
public class DataProviderEES4S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Radio Communication ", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Fiber Optic Communication ", Differential_Calculus);
        MoviesDetails.put(" Microwave Techniques ", Applications_of_Differentiation);
        MoviesDetails.put(" Satellite Communication  ", Integral_Calculus);
        MoviesDetails.put("Mobile and Data Communication ", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Basics of Computer Networks  ", Differential_Equiations);
