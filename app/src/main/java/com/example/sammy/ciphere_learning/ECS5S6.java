...
public class ECS5S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs5_s6);
        Exp_list = findViewById(R.id.exp_listecs5s6);
        //Movies_category = DataProviderECS5S6.getInfo();
