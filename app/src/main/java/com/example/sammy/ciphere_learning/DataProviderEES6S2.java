...
public class DataProviderEES6S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("PBASIC MANAGEMENT SKILLS ", Digital_and_Computer_Fundamentals);
        MoviesDetails.put(" MAINTENANCE AND TOTAL QUALITY MANAGEMENT  ", Differential_Calculus);
        MoviesDetails.put("ENERGY MANAGEMENT ", Applications_of_Differentiation);
        MoviesDetails.put(" ELECTRICAL ENERGY CONSERVATION  ", Integral_Calculus);
        MoviesDetails.put("ENERGY AUDIT ", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("SAFETY AND ENVIRONMENTAL ISSUES ", Differential_Equiations);
