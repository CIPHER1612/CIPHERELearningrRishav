...
public class CES4S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces4_s4);
        Exp_list = findViewById(R.id.exp_listces4s4);
        Movies_category = DataProviderCES4S4.getInfo();
