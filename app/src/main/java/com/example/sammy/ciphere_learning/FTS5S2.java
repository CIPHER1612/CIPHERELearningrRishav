...
public class FTS5S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts5_s2);
        Exp_list = findViewById(R.id.exp_listfts5s2);
        Movies_category = DataProviderFTS5S2.getInfo();
