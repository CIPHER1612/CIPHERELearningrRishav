...
public class FTS6S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts6_s4);
        Exp_list = findViewById(R.id.exp_listfts6s4);
        Movies_category = DataProviderFTS6S4.getInfo();
