...
public class CES3S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces3_s2);
        Exp_list = findViewById(R.id.exp_listces3s2);
        Movies_category = DataProviderCES3S2.getInfo();
