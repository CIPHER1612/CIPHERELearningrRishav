...
public class CES4S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces4_s6);
        Exp_list = findViewById(R.id.exp_listces4s6);
        Movies_category = DataProviderCES4S6.getInfo();
