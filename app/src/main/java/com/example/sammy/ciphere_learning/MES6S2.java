...
public class MES6S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes6_s2);
        Exp_list = findViewById(R.id.exp_listmes6s2);
        Movies_category = DataProviderMES6S2.getInfo();
