...
public class CES2S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces2_s1);
        Exp_list = findViewById(R.id.exp_listces2s1);
        Movies_category = DataProviderCES2S1.getInfo();
