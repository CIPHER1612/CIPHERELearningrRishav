...
public class FTS6S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts6_s3);
        Exp_list = findViewById(R.id.exp_listfts6s3);
        Movies_category = DataProviderFTS6S3.getInfo();
