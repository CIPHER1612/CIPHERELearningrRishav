...
public class CES3S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces3_s1);
        Exp_list = findViewById(R.id.exp_listces3s1);
        Movies_category = DataProviderCES3S1.getInfo();
