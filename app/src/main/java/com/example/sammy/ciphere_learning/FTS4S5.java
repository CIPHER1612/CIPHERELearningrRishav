...
public class FTS4S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts4_s5);
        Exp_list = findViewById(R.id.exp_listfts4s5);
        Movies_category = DataProviderFTS4S5.getInfo();
