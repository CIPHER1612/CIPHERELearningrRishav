...
public class ECS2S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs2_s5);
        Exp_list = findViewById(R.id.exp_listecs2s5);
        Movies_category = DataProviderECS2S5.getInfo();
