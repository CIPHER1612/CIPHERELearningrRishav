...
public class DataProviderEES3S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Hydroelectric and thermal power plants ", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Nuclear power plant, Diesel power plant and Gas turbine power plant", Differential_Calculus);
        MoviesDetails.put("  Solar photovoltaic system ", Applications_of_Differentiation);
        MoviesDetails.put("Wind Power plant ", Integral_Calculus);
        MoviesDetails.put("Tidal Power Plant , Wave energy , Ocean thermal energy and Biomass Power Plant", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Fuel Cells, Hybrid power plant and Power factor improvement",Differential_Equiations);
