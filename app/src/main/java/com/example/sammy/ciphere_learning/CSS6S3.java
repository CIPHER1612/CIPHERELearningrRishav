...
public class CSS6S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_css6_s3);
        Exp_list = findViewById(R.id.exp_listcss6s3);
        Movies_category = DataProviderCSS6S3.getInfo();
