...
public class DataProviderFTS5S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("STUDY OF GARMENTS", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("STUDY OF GARMENTS", Differential_Calculus);
        MoviesDetails.put("LAYOUT & ESTIMATION", Applications_of_Differentiation);
        MoviesDetails.put("DEFECTS & REMEDIES", Integral_Calculus);
        MoviesDetails.put("MODEL FORM & MEASUREMENTS", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("BASIC PATTERN", Differential_Equiations);
