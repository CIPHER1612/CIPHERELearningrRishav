...
public class FTS6S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts6_s6);
        Exp_list = findViewById(R.id.exp_listfts6s6);
        Movies_category = DataProviderFTS6S6.getInfo();
