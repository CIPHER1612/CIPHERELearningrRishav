...
public class ECS2S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs2_s3);
        Exp_list = findViewById(R.id.exp_listecs2s3);
        Movies_category = DataProviderECS2S3.getInfo();
