...
public class FTS3S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts3_s3);
        Exp_list = findViewById(R.id.exp_listfts3s3);
        Movies_category = DataProviderFTS3S3.getInfo();
