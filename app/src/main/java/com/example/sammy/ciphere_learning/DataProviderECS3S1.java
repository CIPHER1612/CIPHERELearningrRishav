...
public class DataProviderECS3S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Power supplies", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("BJT Biasing and amplifiers", Differential_Calculus);
        MoviesDetails.put("OP-AMP and applications ", Applications_of_Differentiation);
        MoviesDetails.put("Active filters and instrumentation amplifier", Integral_Calculus);
        MoviesDetails.put("Wave-shaping circuits ", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put(" Sinusoidal oscillators ", Differential_Equiations);
