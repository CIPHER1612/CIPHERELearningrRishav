...
public class DataProviderCES3S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put(" Theodolite Surveying", Digital_and_Computer_Fundamentals);
        MoviesDetails.put(" Trigonometric Levelling ", Differential_Calculus);
        MoviesDetails.put("Tacheometric surveying", Applications_of_Differentiation);
        MoviesDetails.put("Curves", Integral_Calculus);
        MoviesDetails.put("Modern Surveying", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Total Station", Differential_Equiations);
