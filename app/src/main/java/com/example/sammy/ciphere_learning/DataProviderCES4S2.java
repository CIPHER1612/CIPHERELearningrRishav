...
public class DataProviderCES4S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Introduction to Concrete and Concrete Ingredients", Digital_and_Computer_Fundamentals);
        MoviesDetails.put(" Behavior of concrete ", Differential_Calculus);
        MoviesDetails.put("Properties of Concrete", Applications_of_Differentiation);
        MoviesDetails.put("Concrete Mix Design", Integral_Calculus);
        MoviesDetails.put(" Concrete Operations ", Integral_Calculus);
        MoviesDetails.put("Special types of concrete ", Definite_Integrals_and_its_Applicaitons);
