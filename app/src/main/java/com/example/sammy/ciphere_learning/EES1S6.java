...
public class EES1S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces1_s6);
        Exp_list = findViewById(R.id.exp_listces1s6);
        Movies_category = DataProviderEES1S6.getInfo();
