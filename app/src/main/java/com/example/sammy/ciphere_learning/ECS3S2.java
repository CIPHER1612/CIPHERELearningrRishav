...
public class ECS3S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs3_s2);
        Exp_list = findViewById(R.id.exp_listecs3s2);
        Movies_category = DataProviderECS3S2.getInfo();
