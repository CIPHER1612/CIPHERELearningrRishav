...
public class CES6S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces6_s2);
        Exp_list = findViewById(R.id.exp_listces6s2);
        Movies_category = DataProviderCES6S2.getInfo();
