...
public class DataProviderCES3S4 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Soil and its Properties, Foundation", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Stone & Brick masonry, Dampness and its Prevention", Differential_Calculus);
        MoviesDetails.put(" Lintels & Arches, Doors and Windows ", Applications_of_Differentiation);
        MoviesDetails.put(" Stairs , Floors, Roofs ", Integral_Calculus);
        MoviesDetails.put("Scaffolding and Shoring, Plastering, Pointing and Painting  ", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Miscellaneous", Differential_Equiations);
