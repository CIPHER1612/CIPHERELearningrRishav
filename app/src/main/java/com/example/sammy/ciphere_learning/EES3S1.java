...
public class EES3S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees3_s1);
        Exp_list = findViewById(R.id.exp_listees3s1);
        Movies_category = DataProviderEES3S1.getInfo();
