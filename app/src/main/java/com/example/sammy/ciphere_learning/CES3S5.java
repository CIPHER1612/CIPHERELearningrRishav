...
public class CES3S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces3_s5);
        Exp_list = findViewById(R.id.exp_listces3s5);
        Movies_category = DataProviderCES3S5.getInfo();
