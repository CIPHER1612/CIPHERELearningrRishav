...
public class CES6S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces6_s5);
        Exp_list = findViewById(R.id.exp_listces6s5);
        Movies_category = DataProviderCES6S5.getInfo();
