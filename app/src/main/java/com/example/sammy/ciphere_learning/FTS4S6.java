...
public class FTS4S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts4_s6);
        Exp_list = findViewById(R.id.exp_listfts4s6);
        Movies_category = DataProviderFTS4S6.getInfo();
