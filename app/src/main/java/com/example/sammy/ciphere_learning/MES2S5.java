...
public class MES2S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes2_s5);
        Exp_list = findViewById(R.id.exp_listmes2s5);
        Movies_category = DataProviderMES2S5.getInfo();
