...
public class EES2S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees2_s5);
        Exp_list = findViewById(R.id.exp_listees2s5);
        Movies_category = DataProviderEES2S5.getInfo();
