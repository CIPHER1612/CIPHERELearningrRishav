...
public class DataProviderCES1S4 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("INTRODUCTION TO ENGINEERING DRAWING AND LETTERING PRACTICE ", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("DIMENSIONING PRACTICE", Differential_Calculus);
        MoviesDetails.put("GEOMETRICAL CONSTRUCTIONS AND CONIC SECTIONS ", Applications_of_Differentiation);
        MoviesDetails.put("SCALES", Integral_Calculus);
        MoviesDetails.put("ORTHOGRAPHIC PROJECTION AND PROJECTION OF POINTS", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("PROJECTION OF LINES AND  PLANES SURFACES", Differential_Equiations);
