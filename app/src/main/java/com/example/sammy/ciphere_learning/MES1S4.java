...
public class MES1S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes1_s4);
        Exp_list = findViewById(R.id.exp_listmes1s4);
        Movies_category = DataProviderMES1S4.getInfo();
