...
public class DataProviderFTS4S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Regional Embroidery-I", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Regional Embroidery-II", Differential_Calculus);
        MoviesDetails.put("Machine Embroidery", Applications_of_Differentiation);
        MoviesDetails.put("Estimation and costing", Integral_Calculus);
        MoviesDetails.put("Knitting", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Laundry", Differential_Equiations);
