...
public class MES6S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes6_s1);
        Exp_list = findViewById(R.id.exp_listmes6s1);
        Movies_category = DataProviderMES6S1.getInfo();
