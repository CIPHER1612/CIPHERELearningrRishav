...
public class ECS2S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs2_s6);
        Exp_list = findViewById(R.id.exp_listecs2s6);
        Movies_category = DataProviderECS2S6.getInfo();
