...
public class DataProviderCES3S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("INTRODUCTION TO ENGINEERING MECHANICS", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("SIMPLE STRESSES AND STRAINS", Differential_Calculus);
        MoviesDetails.put("GEOMETRICAL PROPERTIES OF SECTIONS", Applications_of_Differentiation);
        MoviesDetails.put("BENDING MOMENTS AND SHEAR FORCE", Integral_Calculus);
        MoviesDetails.put("Theory of simple bending", Integral_Calculus);
        MoviesDetails.put("SLOPE AND DEFLECTION OF BEAMS", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("COLUMNS", Differential_Equiations);
