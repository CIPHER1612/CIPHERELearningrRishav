...
public class DataProviderCES5S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Introduction to RCC, Analysis of singly reinforced, doubly reinforced beams, T-beam", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Design of  singly reinforced, doubly reinforced beams, Lintels", Differential_Calculus);
        MoviesDetails.put("Design of Slabs", Applications_of_Differentiation);
        MoviesDetails.put("Design of Column and Footings", Integral_Calculus);
        MoviesDetails.put("Design of Dog-legged Staircase", Integral_Calculus);
        MoviesDetails.put("Pre-stressed Concrete", Definite_Integrals_and_its_Applicaitons);
