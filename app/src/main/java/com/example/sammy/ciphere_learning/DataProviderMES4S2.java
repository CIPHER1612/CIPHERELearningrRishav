...
public class DataProviderMES4S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("BASIC CONCEPTS AND LAWS OF THERMODYNAMICS", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("THERMODYNAMIC PROCESSES", Differential_Calculus);
        MoviesDetails.put("THERMODYNAMIC CYCLES", Applications_of_Differentiation);
        MoviesDetails.put("IC ENGINESPERFORMANCE OF I.C ENGINES", Integral_Calculus);
        MoviesDetails.put("HEAT TRANSFER", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("GAS TURBINE AND JET PROPULSION SYSTEMS\n", Differential_Equiations);
