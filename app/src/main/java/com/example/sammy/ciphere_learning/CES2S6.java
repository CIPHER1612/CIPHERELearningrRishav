...
public class CES2S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces2_s6);
        Exp_list = findViewById(R.id.exp_listces2s6);
        Movies_category = DataProviderCES2S6.getInfo();
