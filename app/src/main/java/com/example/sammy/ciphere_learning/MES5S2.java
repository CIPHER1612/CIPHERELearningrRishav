...
public class MES5S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes5_s2);
        Exp_list = findViewById(R.id.exp_listmes5s2);
        Movies_category = DataProviderMES5S2.getInfo();
