...
public class FTS4S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts4_s1);
        Exp_list = findViewById(R.id.exp_listfts4s1);
        Movies_category = DataProviderFTS4S1.getInfo();
