...
public class ECS6S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs6_s1);
        Exp_list = findViewById(R.id.exp_listecs6s1);
        Movies_category = DataProviderECS6S1.getInfo();
