...
public class Sem3FT extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sem3_ft);
        ...
        switch (view.getId()) {
           /* case R.id.Subject1:
            ...
            case R.id.Subject7:
                ...
                break;
           case R.id.Subject9:
                startActivity(new Intent(this, FTS5S9.class));
                break;
