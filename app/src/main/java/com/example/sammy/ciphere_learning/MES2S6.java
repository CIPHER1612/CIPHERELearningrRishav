...
public class MES2S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes2_s6);
        Exp_list = findViewById(R.id.exp_listmes2s6);
        Movies_category = DataProviderMES2S6.getInfo();
