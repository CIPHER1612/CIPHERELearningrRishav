...
public class DataProviderCES5S4 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Introduction to Highway Engineering,Highways", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Highway Materials and Pavements,Road drainage", Differential_Calculus);
        MoviesDetails.put("Introduction to Bridges ", Applications_of_Differentiation);
        MoviesDetails.put("Introduction,Railway track,Track Components", Integral_Calculus);
        MoviesDetails.put("Points and  crossings,Railway stations and yards,Suburban railways in metro cities", Integral_Calculus);
        MoviesDetails.put(" Introduction to Tunnel Engineering ,Terms used in Airport and Harbour", Definite_Integrals_and_its_Applicaitons);
