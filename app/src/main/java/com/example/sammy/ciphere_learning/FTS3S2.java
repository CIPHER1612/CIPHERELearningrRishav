...
public class FTS3S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts3_s2);
        Exp_list = findViewById(R.id.exp_listfts3s2);
        Movies_category = DataProviderFTS3S2.getInfo();
