...
public class DataProviderCES2S4 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("PROJECTION OF SOLIDS", Digital_and_Computer_Fundamentals);
        MoviesDetails.put(" CONVERSION OF ISOMETERIC VIEWS INTO ORTHOGRAPHIC VIEWS", Differential_Calculus);
        MoviesDetails.put("ISOMETRIC PROJECTIONS", Applications_of_Differentiation);
        MoviesDetails.put("PERSPECTIVE PROJECTIONS", Integral_Calculus);
        MoviesDetails.put("CROSS SECTION OF BUILDING COMPONENTS", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("BUILDING DRAWING", Differential_Equiations);
