...
public class EES6S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees6_s1);
        Exp_list = findViewById(R.id.exp_listees6s1);
        Movies_category = DataProviderEES6S1.getInfo();
