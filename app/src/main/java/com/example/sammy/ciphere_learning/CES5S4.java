...
public class CES5S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces5_s4);
        Exp_list = findViewById(R.id.exp_listces5s4);
        Movies_category = DataProviderCES5S4.getInfo();
