...
public class DataProviderEES5S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put(" Fundamentals of Protection ", Digital_and_Computer_Fundamentals);
        MoviesDetails.put(" Fuse and Circuit Breakers ", Differential_Calculus);
        MoviesDetails.put(" Protective Relays  ", Applications_of_Differentiation);
        MoviesDetails.put(" Protection of Generators and Transformers ", Integral_Calculus);
        MoviesDetails.put("Protection of Feeders and Bus-Bars   ", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Substation and Maintenance ", Differential_Equiations);
