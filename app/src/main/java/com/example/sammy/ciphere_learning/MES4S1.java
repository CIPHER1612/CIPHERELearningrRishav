...
public class MES4S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes4_s1);
        Exp_list = findViewById(R.id.exp_listmes4s1);
        Movies_category = DataProviderMES4S1.getInfo();
