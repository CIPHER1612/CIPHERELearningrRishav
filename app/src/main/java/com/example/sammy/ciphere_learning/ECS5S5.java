...
public class ECS5S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs5_s5);
        Exp_list = findViewById(R.id.exp_listecs5s5);
        //Movies_category = DataProviderECS5S5.getInfo();
