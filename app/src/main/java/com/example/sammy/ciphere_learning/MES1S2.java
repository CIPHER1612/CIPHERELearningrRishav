...
public class MES1S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes1_s2);
        Exp_list = findViewById(R.id.exp_listmes1s2);
        Movies_category = DataProviderMES1S2.getInfo();
