...
public class DataProviderECS1S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Basics of Electricity", Digital_and_Computer_Fundamentals);
        MoviesDetails.put(" Electrostatics ", Differential_Calculus);
        MoviesDetails.put(" Electromagnetic Induction ", Applications_of_Differentiation);
        MoviesDetails.put("AC Circuits ", Integral_Calculus);
        MoviesDetails.put(" Electrical Machines ", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put(" Passive Components ", Differential_Equiations);
