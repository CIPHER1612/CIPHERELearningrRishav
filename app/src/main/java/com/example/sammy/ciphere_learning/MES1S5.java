...
public class MES1S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes1_s5);
        Exp_list = findViewById(R.id.exp_listmes1s5);
        Movies_category = DataProviderMES1S5.getInfo();
