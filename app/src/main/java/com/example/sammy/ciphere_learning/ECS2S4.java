...
public class ECS2S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs2_s4);
        Exp_list = findViewById(R.id.exp_listecs2s4);
        Movies_category = DataProviderECS2S4.getInfo();
