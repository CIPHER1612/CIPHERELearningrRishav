...
public class CSS4S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_css4_s6);
        Exp_list = findViewById(R.id.exp_listcss4s6);
        Movies_category = DataProviderCSS4S6.getInfo();
