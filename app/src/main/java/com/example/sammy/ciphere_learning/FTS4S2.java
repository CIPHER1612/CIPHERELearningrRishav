...
public class FTS4S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts4_s2);
        Exp_list = findViewById(R.id.exp_listfts4s2);
        Movies_category = DataProviderFTS4S2.getInfo();
