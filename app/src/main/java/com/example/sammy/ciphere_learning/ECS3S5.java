...
public class ECS3S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs3_s5);
        Exp_list = findViewById(R.id.exp_listecs3s5);
        Movies_category = DataProviderECS3S5.getInfo();
