...
public class FTS5S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts5_s1);
        Exp_list = findViewById(R.id.exp_listfts5s1);
        Movies_category = DataProviderFTS5S1.getInfo();
