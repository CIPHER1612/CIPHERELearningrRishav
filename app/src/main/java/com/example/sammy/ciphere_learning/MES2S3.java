...
public class MES2S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes2_s3);
        Exp_list = findViewById(R.id.exp_listmes2s3);
        Movies_category = DataProviderMES2S3.getInfo();
