...
public class MES3S7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes3_s7);
        Exp_list = findViewById(R.id.exp_listmes3s7);
        Movies_category = DataProviderMES3S7.getInfo();
