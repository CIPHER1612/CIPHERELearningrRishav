...
public class DataProviderCES4S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Introduction , quantity of sewage", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Characteristics, analysis of sewage and sewerage system", Differential_Calculus);
        MoviesDetails.put("Sanitation in buildings and sanitary fittings.", Applications_of_Differentiation);
        MoviesDetails.put("Sewage treatment ,and  disposal", Integral_Calculus);
        MoviesDetails.put("Surface and storm water drainage  and sewerage appurtenances,", Integral_Calculus);
        MoviesDetails.put("Air and noise pollution", Definite_Integrals_and_its_Applicaitons);
