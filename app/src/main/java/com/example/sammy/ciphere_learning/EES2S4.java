...
public class EES2S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees2_s4);
        Exp_list = findViewById(R.id.exp_listees2s4);
        Movies_category = DataProviderEES2S4.getInfo();
