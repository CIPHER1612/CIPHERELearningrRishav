...
public class DataProviderCES5S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("INTRODUCTION TO WATER RESOURCES ENGINEERING ", Digital_and_Computer_Fundamentals);
        MoviesDetails.put(" HYDROLOGY", Differential_Calculus);
        MoviesDetails.put("METHODS OF IRRIGATION  AND WATER REQUIREMENT OF  CROPS\n", Applications_of_Differentiation);
        MoviesDetails.put("RESERVOIRS AND DAMS ", Integral_Calculus);
        MoviesDetails.put("DISTRIBUTION WORKS CROSS DRAINAGE WORKS DIVERSION WORKS", Integral_Calculus);
        MoviesDetails.put("GROUND WATER ENGINEERING AND WATER RESOURCE MANAGEMENT:", Definite_Integrals_and_its_Applicaitons);
