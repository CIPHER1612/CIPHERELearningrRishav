...
public class ECS3S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs3_s1);
        Exp_list = findViewById(R.id.exp_listecs3s1);
        Movies_category = DataProviderECS3S1.getInfo();
