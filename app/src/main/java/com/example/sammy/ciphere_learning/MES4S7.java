...
public class MES4S7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes4_s7);
        Exp_list = findViewById(R.id.exp_listmes4s7);
        Movies_category = DataProviderMES4S7.getInfo();
