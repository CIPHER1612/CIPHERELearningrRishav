...
public class EES1S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces1_s1);
        Exp_list = findViewById(R.id.exp_listces1s1);
        Movies_category = DataProviderEES1S1.getInfo();
