...
public class DataProviderFTS3S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Technical terms", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Study of fabrics", Differential_Calculus);
        MoviesDetails.put("Study of measurements", Applications_of_Differentiation);
        MoviesDetails.put("Pressing and labelling", Integral_Calculus);
        MoviesDetails.put("Study of boys garments", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Lay out and estimation", Differential_Equiations);
