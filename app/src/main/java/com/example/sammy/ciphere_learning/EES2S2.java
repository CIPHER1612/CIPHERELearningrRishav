...
public class EES2S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees2_s2);
        Exp_list = findViewById(R.id.exp_listees2s2);
        Movies_category = DataProviderEES2S2.getInfo();
