...
public class DataProviderCES3S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put(" Environment and ecology, water requirement, sources of water, collection and conveyance of water", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Quality & treatment of water ", Differential_Calculus);
        MoviesDetails.put("  Appurtenances and distribution system", Applications_of_Differentiation);
        MoviesDetails.put(" Water supply arrangement in buildings\n", Integral_Calculus);
        MoviesDetails.put("Water conservation, rural water supply", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Water pollution and control", Differential_Equiations);
