...
public class MES4S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes4_s4);
        Exp_list = findViewById(R.id.exp_listmes4s4);
        Movies_category = DataProviderMES4S4.getInfo();
