...
public class EES6S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees6_s4);
        Exp_list = findViewById(R.id.exp_listees6s4);
        Movies_category = DataProviderEES6S4.getInfo();
