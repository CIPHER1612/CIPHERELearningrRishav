...
public class CES1S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces1_s3);
        Exp_list = findViewById(R.id.exp_listces1s3);
        Movies_category = DataProviderCES1S3.getInfo();
