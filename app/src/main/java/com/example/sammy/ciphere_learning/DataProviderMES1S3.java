...
public class DataProviderMES1S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Materials for Manufacturing", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Basic Manufacturing process", Differential_Calculus);
        MoviesDetails.put("Basic Fabrication Process ", Applications_of_Differentiation);
        MoviesDetails.put("Metal casting processes ", Integral_Calculus);
        MoviesDetails.put("Sheet metal processes ", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Powder metallurgy", Differential_Equiations);
