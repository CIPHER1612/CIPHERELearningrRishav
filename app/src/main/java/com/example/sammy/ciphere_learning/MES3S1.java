...
public class MES3S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes3_s1);
        Exp_list = findViewById(R.id.exp_listmes3s1);
        Movies_category = DataProviderMES3S1.getInfo();
