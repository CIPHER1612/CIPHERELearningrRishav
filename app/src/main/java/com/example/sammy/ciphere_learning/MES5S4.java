...
public class MES5S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes5_s4);
        Exp_list = findViewById(R.id.exp_listmes5s4);
        Movies_category = DataProviderMES5S4.getInfo();
