...
public class MES3S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes3_s5);
        Exp_list = findViewById(R.id.exp_listmes3s5);
        Movies_category = DataProviderMES3S5.getInfo();
