...
public class DataProviderMES5S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("BASICS OF MANAGEMENT", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("PRODUCTION MANAGEMENT", Differential_Calculus);
        MoviesDetails.put("MATERIALS MANAGEMENT", Applications_of_Differentiation);
        MoviesDetails.put("TOTAL QUALITY MANAGEMENT", Integral_Calculus);
        MoviesDetails.put("PLANT MAINTENANCE AND INDUSTRIAL SAFETY", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("SOCIAL ISSUES AND THE ENVIRONMENT", Differential_Equiations);
