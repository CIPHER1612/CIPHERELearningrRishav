...
public class DataProviderFTS3S4 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Yarns", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Yarn Twist and count", Differential_Calculus);
        MoviesDetails.put("Looms", Applications_of_Differentiation);
        MoviesDetails.put("Weaves", Integral_Calculus);
        MoviesDetails.put("Finishing processes", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Laundering", Differential_Equiations);
