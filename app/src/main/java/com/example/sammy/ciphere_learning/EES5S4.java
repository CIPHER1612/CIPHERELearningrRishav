...
public class EES5S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees5_s4);
        Exp_list = findViewById(R.id.exp_listees5s4);
        Movies_category = DataProviderEES5S4.getInfo();
