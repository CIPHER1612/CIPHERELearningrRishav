...
public class DataProviderFTS4S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Patterns", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Measurements", Differential_Calculus);
        MoviesDetails.put("Technical terms", Applications_of_Differentiation);
        MoviesDetails.put("Darning and patching", Integral_Calculus);
        MoviesDetails.put("Study of garments", Definite_Integrals_and_its_Applicaitons);
