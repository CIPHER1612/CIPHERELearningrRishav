...
public class DataProviderCES5S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("INTRODUCTION TO ESTIMATION", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("SPECIFICATIONS", Differential_Calculus);
        MoviesDetails.put("ANALYSIS  OF  RATES", Applications_of_Differentiation);
        MoviesDetails.put("DETAILED AND ABSTRACT ", Integral_Calculus);
        MoviesDetails.put(" ESTIMATE OF BUILDINGS", Integral_Calculus);
        MoviesDetails.put("ESTIMATION OF ROAD WORKS", Definite_Integrals_and_its_Applicaitons);
