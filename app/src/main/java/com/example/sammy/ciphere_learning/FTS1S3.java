...
public class FTS1S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts1_s3);
        Exp_list = findViewById(R.id.exp_listfts1s3);
        Movies_category = DataProviderFTS1S3.getInfo();
