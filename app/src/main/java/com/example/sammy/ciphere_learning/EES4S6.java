...
public class EES4S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees4_s6);
        Exp_list = findViewById(R.id.exp_listees4s6);
        Movies_category = DataProviderEES4S6.getInfo();
