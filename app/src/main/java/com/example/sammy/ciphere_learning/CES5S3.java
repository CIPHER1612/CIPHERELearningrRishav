...
public class CES5S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces5_s3);
        Exp_list = findViewById(R.id.exp_listces5s3);
        Movies_category = DataProviderCES5S3.getInfo();
