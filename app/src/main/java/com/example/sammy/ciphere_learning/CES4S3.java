...
public class CES4S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces4_s3);
        Exp_list = findViewById(R.id.exp_listces4s3);
        Movies_category = DataProviderCES4S3.getInfo();
