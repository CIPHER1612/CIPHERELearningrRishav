...
public class EES6S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees6_s2);
        Exp_list = findViewById(R.id.exp_listees6s2);
        Movies_category = DataProviderEES6S2.getInfo();
