...
public class EES4S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees4_s3);
        Exp_list = findViewById(R.id.exp_listees4s3);
        Movies_category = DataProviderEES4S3.getInfo();
