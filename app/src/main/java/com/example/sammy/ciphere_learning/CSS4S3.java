...
public class CSS4S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_css4_s3);
        Exp_list = findViewById(R.id.exp_listcss4s3);
        Movies_category = DataProviderCSS4S3.getInfo();
