...
public class CES6S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces6_s3);
        Exp_list = findViewById(R.id.exp_listces6s3);
        Movies_category = DataProviderCES6S3.getInfo();
