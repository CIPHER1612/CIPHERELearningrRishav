...
public class FTS4S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts4_s4);
        Exp_list = findViewById(R.id.exp_listfts4s4);
        Movies_category = DataProviderFTS4S4.getInfo();
