...
public class MES6S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes6_s6);
        Exp_list = findViewById(R.id.exp_listmes6s6);
        Movies_category = DataProviderMES6S6.getInfo();
