...
public class CES6S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces6_s1);
        Exp_list = findViewById(R.id.exp_listces6s1);
        Movies_category = DataProviderCES6S1.getInfo();
