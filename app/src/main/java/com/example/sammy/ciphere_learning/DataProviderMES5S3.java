...
public class DataProviderMES5S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("INTRODUCTION TO DESIGN", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("DESIGN OF FASTENERS", Differential_Calculus);
        MoviesDetails.put("DESIGN OF SHAFTS, KEYS", Applications_of_Differentiation);
        MoviesDetails.put("DESIGN OF SIMPLE MACHINE PARTS", Integral_Calculus);
        MoviesDetails.put("DESIGN OF SPRINGS ", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("ERGONOMICS & AESTHETIC CONSIDERATION IN DESIGN", Differential_Equiations);
