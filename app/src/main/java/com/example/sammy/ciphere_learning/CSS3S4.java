...
public class CSS3S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_css3_s4);
        Exp_list = findViewById(R.id.exp_listcss3s4);
        Movies_category = DataProviderCSS3S4.getInfo();
