...
public class EES4S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees4_s5);
        Exp_list = findViewById(R.id.exp_listees4s5);
        Movies_category = DataProviderEES4S5.getInfo();
