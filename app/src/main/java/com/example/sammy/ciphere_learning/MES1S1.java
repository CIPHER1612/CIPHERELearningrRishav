...
public class MES1S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes1_s1);
        Exp_list = findViewById(R.id.exp_listmes1s1);
        Movies_category = DataProviderMES1S1.getInfo();
