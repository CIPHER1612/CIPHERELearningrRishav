...
public class CSS4S7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_css4_s7);
        Exp_list = findViewById(R.id.exp_listcss4s7);
        Movies_category = DataProviderCSS4S7.getInfo();
