...
public class CSS5S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_css5_s2);
        Exp_list = findViewById(R.id.exp_listcss5s2);
        Movies_category = DataProviderCSS5S2.getInfo();
