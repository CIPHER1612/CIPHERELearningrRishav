...
public class FTS5S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts5_s4);
        Exp_list = findViewById(R.id.exp_listfts5s4);
        Movies_category = DataProviderFTS5S4.getInfo();
