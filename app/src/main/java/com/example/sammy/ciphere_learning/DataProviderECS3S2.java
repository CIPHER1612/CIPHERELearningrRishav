...
public class DataProviderECS3S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Combinational logic circuits", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Basic sequential circuits", Differential_Calculus);
        MoviesDetails.put("Registers and counters", Applications_of_Differentiation);
        MoviesDetails.put(" D to A and A to D converters ", Integral_Calculus);
        MoviesDetails.put("Memories and programmable devices ", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put(" Digital integrated circuits ", Differential_Equiations);
