...
public class DataProviderMES6S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("INTRODUCTION TO ESTIMATION & COSTING", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("ESTIMATION OF MATERIALS COST", Differential_Calculus);
        MoviesDetails.put("ESTIMATION IN MACHINE SHOP", Applications_of_Differentiation);
        MoviesDetails.put("ESTIMATION IN WELDING & SHEET METAL SHOP", Integral_Calculus);
        MoviesDetails.put("ESTIMATION IN FORGING SHOP & FOUNDARY SHOP", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("PROCESS COSTING & ACCOUNTING", Differential_Equiations);
