...
public class DataProviderMES5S4 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("MECHATRONICS, SENSORS AND TRANSDUCERS", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("DIGITAL LOGIC AND DATA PRESENTATION", Differential_Calculus);
        MoviesDetails.put("ACTUATION SYSTEMS ", Applications_of_Differentiation);
        MoviesDetails.put("SYSTEM MODELS AND CONTROLLERS", Integral_Calculus);
        MoviesDetails.put("PROGRAMMABLE LOGIC CONTROLLERS", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("COMMUNICATION AND  DESIGN OF MECHATRONICS SYSTEM", Differential_Equiations);
