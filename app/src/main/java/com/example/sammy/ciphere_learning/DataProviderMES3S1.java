...
public class DataProviderMES3S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("SIMPLE STRESSES AND STRAIN", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("MOMENT OF INERTIA", Differential_Calculus);
        MoviesDetails.put("SHEAR FORCE AND BENDING MOMENT ", Applications_of_Differentiation);
        MoviesDetails.put("THEORY OF SIMPLE BENDING", Integral_Calculus);
        MoviesDetails.put("STRAIN ENERGY AND IMPACT LOADING", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("TORSION OF CIRCULAR SHAFT", Differential_Equiations);
