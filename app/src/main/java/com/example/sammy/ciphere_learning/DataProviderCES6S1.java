...
public class DataProviderCES6S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Introduction to Limit state design of steel structures ", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Bolted Connections,Welded Connections ", Differential_Calculus);
        MoviesDetails.put("Flexural Members ", Applications_of_Differentiation);
        MoviesDetails.put("Tension Members", Integral_Calculus);
        MoviesDetails.put("Compression Members,Column Bases ", Integral_Calculus);
        MoviesDetails.put("Analysis and Design of Masonry dams,Analysis and Design of Retaining walls", Definite_Integrals_and_its_Applicaitons);
