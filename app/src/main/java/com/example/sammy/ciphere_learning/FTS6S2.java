...
public class FTS6S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts6_s2);
        Exp_list = findViewById(R.id.exp_listfts6s2);
        Movies_category = DataProviderFTS6S2.getInfo();
