...
public class EES2S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees2_s3);
        Exp_list = findViewById(R.id.exp_listees2s3);
        Movies_category = DataProviderEES2S3.getInfo();
