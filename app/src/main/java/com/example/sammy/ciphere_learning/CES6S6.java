...
public class CES6S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces6_s6);
        Exp_list = findViewById(R.id.exp_listces6s6);
        Movies_category = DataProviderCES6S6.getInfo();
