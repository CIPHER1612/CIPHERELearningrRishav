...
public class MES2S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes2_s2);
        Exp_list = findViewById(R.id.exp_listmes2s2);
        Movies_category = DataProviderMES2S2.getInfo();
