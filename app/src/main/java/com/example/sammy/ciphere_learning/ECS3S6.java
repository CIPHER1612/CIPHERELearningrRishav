...
public class ECS3S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs3_s6);
        Exp_list = findViewById(R.id.exp_listecs3s6);
        Movies_category = DataProviderECS3S6.getInfo();
