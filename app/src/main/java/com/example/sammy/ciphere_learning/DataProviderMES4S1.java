...
public class DataProviderMES4S1 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("INTRODUCTION TO HYDRAULICS", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("DYNAMICS OF FLUIDS", Differential_Calculus);
        MoviesDetails.put("FLOW THROUGH PIPES", Applications_of_Differentiation);
        MoviesDetails.put("HYDRAULIC MACHINES", Integral_Calculus);
        MoviesDetails.put("HYDRAULIC SYSTEMS", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("PNEUMATIC SYSTEMS", Differential_Equiations);
