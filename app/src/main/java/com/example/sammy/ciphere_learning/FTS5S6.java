...
public class FTS5S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts5_s6);
        Exp_list = findViewById(R.id.exp_listfts5s6);
        Movies_category = DataProviderFTS5S6.getInfo();
