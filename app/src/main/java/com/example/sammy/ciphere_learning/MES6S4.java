...
public class MES6S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes6_s4);
        Exp_list = findViewById(R.id.exp_listmes6s4);
        Movies_category = DataProviderMES6S4.getInfo();
