...
public class DataProviderCES4S4 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("SAFETY, RESPONSIBILITIES OF ENGINEERS", Applications_of_Differentiation);
        MoviesDetails.put("ETHICAL ISSUES IN ENGINEERING PRACTICE\n", Integral_Calculus);
        MoviesDetails.put("HUMAN RIGHTS", Integral_Calculus);
        MoviesDetails.put("INDIAN CONSTITUTION", Definite_Integrals_and_its_Applicaitons);
