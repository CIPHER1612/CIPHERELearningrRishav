...
public class DataProviderMES3S4 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("CONVENTIONAL REPRESENTATION", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("THREADED FASTENERS", Differential_Calculus);
        MoviesDetails.put("RIVETED JOINTS", Applications_of_Differentiation);
        MoviesDetails.put("LIMITS, FITS AND TOLERANCES", Integral_Calculus);
        MoviesDetails.put("PRODUCTION DRAWINGS", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("DETAILS TO ASSEMBLY", Differential_Equiations);
