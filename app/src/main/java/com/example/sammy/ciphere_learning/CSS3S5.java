...
public class CSS3S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_css3_s5);
        Exp_list = findViewById(R.id.exp_listcss3s5);
        Movies_category = DataProviderCSS2S2.getInfo();
