...
public class DataProviderMES1S4 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("DIMENSIONING", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("CONIC SECTIONS AND SPECIAL CURVES", Differential_Calculus);
        MoviesDetails.put("ORTHOGRAPHIC PROJECTION AND PROJECTION OF POINTS", Applications_of_Differentiation);
        MoviesDetails.put("PROJECTION OF LINES", Integral_Calculus);
        MoviesDetails.put("PROJECTIONS OF PLANE SURFACES ", Definite_Integrals_and_its_Applicaitons);
