...
public class ECS5S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs5_s2);
        Exp_list = findViewById(R.id.exp_listecs5s2);
        //Movies_category = DataProviderECS5S2.getInfo();
