...
public class CES3S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces3_s6);
        Exp_list = findViewById(R.id.exp_listces3s6);
        Movies_category = DataProviderCES3S6.getInfo();
