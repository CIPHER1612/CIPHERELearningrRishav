...
public class CES2S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces2_s5);
        Exp_list = findViewById(R.id.exp_listces2s5);
        Movies_category = DataProviderCES2S5.getInfo();
