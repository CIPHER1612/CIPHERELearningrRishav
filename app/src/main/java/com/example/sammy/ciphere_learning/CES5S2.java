...
public class CES5S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces5_s2);
        Exp_list = findViewById(R.id.exp_listces5s2);
        Movies_category = DataProviderCES5S2.getInfo();
