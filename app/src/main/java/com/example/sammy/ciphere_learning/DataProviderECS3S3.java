...
public class DataProviderECS3S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Network Theorems ", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Resonance, Filters and attenuators", Differential_Calculus);
        MoviesDetails.put("Transmission Lines ", Applications_of_Differentiation);
        MoviesDetails.put("Antennas and Wave Propagation", Integral_Calculus);
        MoviesDetails.put("Amplitude Modulation and demodulation ", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Frequency Modulation and demodulation", Differential_Equiations);
