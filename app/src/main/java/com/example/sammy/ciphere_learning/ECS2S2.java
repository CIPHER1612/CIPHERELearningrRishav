...
public class ECS2S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs2_s2);
        Exp_list = findViewById(R.id.exp_listecs2s2);
        Movies_category = DataProviderECS2S2.getInfo();
