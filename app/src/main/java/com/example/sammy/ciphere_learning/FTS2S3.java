...
public class FTS2S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts2_s3);
        Exp_list = findViewById(R.id.exp_listfts2s3);
        Movies_category = DataProviderFTS2S3.getInfo();
