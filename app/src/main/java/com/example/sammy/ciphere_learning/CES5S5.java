...
public class CES5S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces5_s5);
        Exp_list = findViewById(R.id.exp_listces5s5);
        Movies_category = DataProviderCES5S5.getInfo();
