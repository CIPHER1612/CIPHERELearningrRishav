...
public class FTS6S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts6_s5);
        Exp_list = findViewById(R.id.exp_listfts6s5);
        Movies_category = DataProviderFTS6S5.getInfo();
