...
public class DataProviderFTS5S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("QUALITY INSPECTION", Differential_Calculus);
        MoviesDetails.put("QUALITY STANDARDS", Applications_of_Differentiation);
        MoviesDetails.put("INDUSTRIAL ENGINEERING", Integral_Calculus);
        MoviesDetails.put("PRODUCT SPECIFICATION", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("PRODUCTION SYSTEMS", Differential_Equiations);
