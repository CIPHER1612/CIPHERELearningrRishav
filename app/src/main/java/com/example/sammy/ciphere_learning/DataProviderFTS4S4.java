...
public class DataProviderFTS4S4 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("PROFESSIONAL ETHICS", Differential_Calculus);
        MoviesDetails.put("SAFETY, RESPONSIBILITIES OF PROFESSIONAL", Applications_of_Differentiation);
        MoviesDetails.put("HUMAN RIGHTS", Integral_Calculus);
        MoviesDetails.put("STATE GOVERNMENT", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("LINDIAN CONSTITUTION", Differential_Equiations);
