...
public class ECS1S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs1_s3);
        Exp_list = findViewById(R.id.exp_listecs1s3);
        Movies_category = DataProviderECS1S3.getInfo();
