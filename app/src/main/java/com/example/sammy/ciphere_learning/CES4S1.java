...
public class CES4S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces4_s1);
        Exp_list = findViewById(R.id.exp_listces4s1);
        Movies_category = DataProviderCES4S1.getInfo();
