...
public class FTS4S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts4_s3);
        Exp_list = findViewById(R.id.exp_listfts4s3);
        Movies_category = DataProviderFTS4S3.getInfo();
