...
public class FTS3S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts3_s1);
        Exp_list = findViewById(R.id.exp_listfts3s1);
        Movies_category = DataProviderFTS3S1.getInfo();
