...
public class CSS1S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_css1_s4);
        Exp_list = findViewById(R.id.exp_listcss1s4);
        Movies_category = DataProviderCSS1S4.getInfo();
