...
public class DataProviderFTS1S4 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("LINES AND SHAPES", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("CONSTRUCT THE PATTERNS", Differential_Calculus);
        MoviesDetails.put("NECK LINES ", Applications_of_Differentiation);
        MoviesDetails.put("SLEEVES", Integral_Calculus);
        MoviesDetails.put("COLLARS", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("TEST", Differential_Equiations);
