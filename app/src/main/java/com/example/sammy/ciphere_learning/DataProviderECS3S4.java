...
public class DataProviderECS3S4 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Basics of measurements", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Transducers", Differential_Calculus);
        MoviesDetails.put("Analog meters ", Applications_of_Differentiation);
        MoviesDetails.put("Testing instruments", Integral_Calculus);
        MoviesDetails.put("Digital meters", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Instrument maintenance", Differential_Equiations);
