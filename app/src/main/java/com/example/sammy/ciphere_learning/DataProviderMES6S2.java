...
public class DataProviderMES6S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("INTRODUCTION TO CIM & AUTOMATION", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("NC AND CNC MACHINES", Differential_Calculus);
        MoviesDetails.put("CONSTRUCTION OF CNC MACHINES", Applications_of_Differentiation);
        MoviesDetails.put("CNC PART PROGRAMMING", Integral_Calculus);
        MoviesDetails.put("GROUP TECHNOLOGY AND CAPP", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("ROBOTICS", Differential_Equiations);
