...
public class DataProviderFTS6S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("ENTERPRENUERSHIP", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("BUSINESS PLAN AND OWNERSHIP", Differential_Calculus);
        MoviesDetails.put("PLANT LAYOUT AND BUDGETING", Applications_of_Differentiation);
        MoviesDetails.put("NEW ENTERPRISE.", Integral_Calculus);
        MoviesDetails.put("RAW MATERIALS AND FINANCIAL SOURCES", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("ENTREPRENEURSHIP ENVIRONMENT CHALLENGES", Differential_Equiations);
