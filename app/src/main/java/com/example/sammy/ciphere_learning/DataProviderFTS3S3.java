...
public class DataProviderFTS3S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Apparel Industry", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Spreading and cutting machines", Differential_Calculus);
        MoviesDetails.put("Sewing Machines", Applications_of_Differentiation);
        MoviesDetails.put("Finishing Machines", Integral_Calculus);
        MoviesDetails.put("Needles and threads", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Care and maintenances", Differential_Equiations);
