...
public class DataProviderMES2S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Electricity and DC Circuits", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Electromagnetism and DC Generators", Differential_Calculus);
        MoviesDetails.put("AC Fundamentals, Transformers and AC Generators ", Applications_of_Differentiation);
        MoviesDetails.put("Electric Motor Drives ", Integral_Calculus);
        MoviesDetails.put("Protective Devices, UPS and Estimation", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Electronic Components and Applications ", Differential_Equiations);
