...
public class DataProviderFTS2S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("INTRODUCTION TO TEXTILES", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("COTTON", Differential_Calculus);
        MoviesDetails.put("LINEN", Applications_of_Differentiation);
        MoviesDetails.put("WOOL", Integral_Calculus);
        MoviesDetails.put("SILK", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("VISCOSE RAYON,NYLON,POLYSTER", Differential_Equiations);
