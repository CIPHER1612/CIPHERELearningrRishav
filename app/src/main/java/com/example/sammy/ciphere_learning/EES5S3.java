...
public class EES5S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees5_s3);
        Exp_list = findViewById(R.id.exp_listees5s3);
        Movies_category = DataProviderEES5S3.getInfo();
