...
public class DataProviderCES3S5 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Site plan and planning of building", Differential_Calculus);
        MoviesDetails.put("Building basic services", Applications_of_Differentiation);
