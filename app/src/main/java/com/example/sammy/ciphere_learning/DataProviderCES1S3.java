...
public class DataProviderCES1S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("STONES", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("VECTORS", Differential_Calculus);
        MoviesDetails.put("BRICKS", Applications_of_Differentiation);
        MoviesDetails.put("TIMBER", Integral_Calculus);
        MoviesDetails.put("CEMENT", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("PAINTS, VARNISH & DISTEMPER", Differential_Equiations);
