...
public class DataProviderEES3S3 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Semiconductors and Diodes", Digital_and_Computer_Fundamentals);
        MoviesDetails.put(" Transistors and MOSFETs", Differential_Calculus);
        MoviesDetails.put("Optoelectronic devices ", Applications_of_Differentiation);
        MoviesDetails.put("Rectifiers, filters and regulators", Integral_Calculus);
        MoviesDetails.put("Amplifiers and Oscillators ", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("OP-AMP and Timers ", Differential_Equiations);
