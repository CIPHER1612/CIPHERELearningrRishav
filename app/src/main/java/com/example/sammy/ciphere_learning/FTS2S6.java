...
public class FTS2S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts2_s6);
        Exp_list = findViewById(R.id.exp_listfts2s6);
        Movies_category = DataProviderFTS2S6.getInfo();
