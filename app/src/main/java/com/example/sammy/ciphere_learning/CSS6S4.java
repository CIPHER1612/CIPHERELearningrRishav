...
public class CSS6S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_css6_s4);
        Exp_list = findViewById(R.id.exp_listcss6s4);
        Movies_category = DataProviderCSS6S4.getInfo();
