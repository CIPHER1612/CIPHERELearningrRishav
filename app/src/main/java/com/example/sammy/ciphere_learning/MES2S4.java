...
public class MES2S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes2_s4);
        Exp_list = findViewById(R.id.exp_listmes2s4);
        Movies_category = DataProviderMES2S4.getInfo();
