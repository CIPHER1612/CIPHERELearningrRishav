...
public class CSS4S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_css4_s5);
        Exp_list = findViewById(R.id.exp_listcss4s5);
        Movies_category = DataProviderCSS4S5.getInfo();
