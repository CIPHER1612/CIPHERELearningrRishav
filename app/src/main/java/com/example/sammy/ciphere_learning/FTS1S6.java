...
public class FTS1S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts1_s6);
        Exp_list = findViewById(R.id.exp_listfts1s6);
        Movies_category = DataProviderFTS1S6.getInfo();
