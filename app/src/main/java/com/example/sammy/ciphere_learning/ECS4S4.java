...
public class ECS4S4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecs4_s4);
        Exp_list = findViewById(R.id.exp_listecs4s4);
       // Movies_category = DataProviderECS4S4.getInfo();
