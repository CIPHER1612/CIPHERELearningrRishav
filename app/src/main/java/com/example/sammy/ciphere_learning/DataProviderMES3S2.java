...
public class DataProviderMES3S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("BASIC KINEMATICS", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("TRANSMISSION OF  POWER", Differential_Calculus);
        MoviesDetails.put("FRICTION", Applications_of_Differentiation);
        MoviesDetails.put("BALANCING", Integral_Calculus);
        MoviesDetails.put("CAM MECHANISAMS", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("MECHANICAL VIBRATIONS", Differential_Equiations);
