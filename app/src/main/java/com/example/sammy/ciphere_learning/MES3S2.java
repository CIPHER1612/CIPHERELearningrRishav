...
public class MES3S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes3_s2);
        Exp_list = findViewById(R.id.exp_listmes3s2);
        Movies_category = DataProviderMES3S2.getInfo();
