...
public class CES3S3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces3_s3);
        Exp_list = findViewById(R.id.exp_listces3s3);
        Movies_category = DataProviderCES3S3.getInfo();
