...
public class MES4S6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes4_s6);
        Exp_list = findViewById(R.id.exp_listmes4s6);
        Movies_category = DataProviderMES4S6.getInfo();
