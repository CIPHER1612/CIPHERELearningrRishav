...
public class EES3S2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ees3_s2);
        Exp_list = findViewById(R.id.exp_listees3s2);
        Movies_category = DataProviderEES3S2.getInfo();
