...
public class DataProviderEES4S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("Characteristics & Classification of instruments ", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("Construction & Operation of indicating instruments", Differential_Calculus);
        MoviesDetails.put("Construction & Operation of Watt meter & energy meter.\n ", Applications_of_Differentiation);
        MoviesDetails.put("Measurement of R,L,C ", Integral_Calculus);
        MoviesDetails.put(" Digital meters", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("Transducers & Sensors, Signal Conditioning circuits ", Differential_Equiations);
