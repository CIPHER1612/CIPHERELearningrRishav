...
public class CES3S7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ces3_s7);
        Exp_list = findViewById(R.id.exp_listces3s7);
        Movies_category = DataProviderCES3S7.getInfo();
