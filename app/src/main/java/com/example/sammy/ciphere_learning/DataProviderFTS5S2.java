...
public class DataProviderFTS5S2 {
    public static HashMap<String, List<String>> getInfo() {
        ...
        MoviesDetails.put("INDIAN TEXTILES", Digital_and_Computer_Fundamentals);
        MoviesDetails.put("TRADITIONAL TEXTILES", Differential_Calculus);
        MoviesDetails.put("TECHNICAL TEXTILES.", Applications_of_Differentiation);
        MoviesDetails.put("SMART & INTELLIGENT TEXTILES", Integral_Calculus);
        MoviesDetails.put("REGIONAL CRAFTS", Definite_Integrals_and_its_Applicaitons);
        MoviesDetails.put("REGIONAL PAINTINGS", Differential_Equiations);
