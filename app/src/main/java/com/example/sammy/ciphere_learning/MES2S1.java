...
public class MES2S1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes2_s1);
        Exp_list = findViewById(R.id.exp_listmes2s1);
        Movies_category = DataProviderMES2S1.getInfo();
