...
public class FTS2S5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fts2_s5);
        Exp_list = findViewById(R.id.exp_listfts2s5);
        Movies_category = DataProviderFTS2S5.getInfo();
